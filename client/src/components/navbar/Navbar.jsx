      ...
      <div className="flex flex-wrap items-center justify-between mx-auto px-4 md:px-12 h-12">
        <a href="/" className="flex items-center">
          <span className="text-xl md:text-2xl font-medium whitespace-nowrap">
            <span className="text-red-500 font-bold">K</span>ishan
            <span className="text-red-500 font-bold">B</span>azar
          </span>
        </a>
        <div className="flex flex-row gap-4 md:gap-8 text-2xl md:text-3xl items-center">
          ...
          >
            <FaUserCircle />
            <span className="text-sm font-medium hidden md:block">Customer</span>
          ...
          {/* Farmer Section */}
          <div
            className="flex flex-row gap-1 justify-center items-center text-green-700 cursor-pointer"
            onMouseEnter={() => {
            ...
            {cookies.seller_access_token && (
              ...
              >
                <ul className="py-2 flex flex-col text-sm gap-2 text-gray-700 ">
                  ...
                  <li
                    onClick={() => {
                      console.log("Seller logout clicked");
